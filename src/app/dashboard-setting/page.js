...
import { Store, FileText, ShoppingBasket, Settings, Plus, Trash, Pencil, ChevronRight, UserCircle, LogOut, HelpCircle } from "lucide-react";
	...
	return (
		<div className="bg-slate-50 h-[100dvh] max-w-screen-sm mx-auto flex flex-col">
			...
			<div className="w-full flex p-6 gap-2 items-center bg-orange-500">
				{/* img */}
				<img className="w-20 h-20 rounded-full" src="https://via.placeholder.com/80x80" />
				{/* Text container */}
			...
			<div className="w-full h-fit overflow-y-scroll">
				...
				<div className=" px-6 py-3 flex items-center bg-white cursor-pointer">
					<div className="text-neutral-500 text-sm tracking-normal font-medium grow flex items-center gap-2">
						<UserCircle className="text-neutral-500" size={24} strokeWidth={2} /> Syntex Store
					</div>
					<ChevronRight className="text-neutral-500" size={24} strokeWidth={2} />
				</div>
				...
				<div className=" px-6 py-3 flex items-center bg-white cursor-pointer">
					<div className="text-neutral-500 text-sm tracking-normal font-medium grow flex items-center gap-2">
						<HelpCircle className="text-neutral-500" size={24} strokeWidth={2} /> Pusat Bantuan
					</div>
					<ChevronRight className="text-neutral-500" size={24} strokeWidth={2} />
				</div>
