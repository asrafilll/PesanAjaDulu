          ...
          <div className="w-full flex gap-2 items-start ssm:flex-wrap">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="text-neutral-500 text-xs font-normal line-clamp-2 hover:line-clamp-none">
                hidangan nasi goreng khas Indonesia yang dihidangkan dengan saus
                balado, yang terkenal dengan cita rasa pedas dan gurih. Hidangan
                ini terdiri dari nasi yang digoreng bersama bumbu dan bahan
                tambahan seperti telur, ayam, udang, atau daging lainnya. Saus
                balado yang khas terbuat dari cabai merah, bawang, dan bumbu
                lainnya yang memberikan rasa pedas dan beraroma. Nasi Goreng
                Balado menggabungkan rasa gurih dan pedas dengan sempurna,
                menjadikannya pilihan yang lezat untuk pencinta makanan pedas.
              </div>
